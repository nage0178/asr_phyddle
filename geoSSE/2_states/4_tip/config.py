...
args = {
    ...
    #-------------------------------#
    'sim_command'       : f'julia sim_one_func.jl 4', # exact command string, argument is output file prefix
    'sim_logging'       : 'verbose',        # verbose, compressed, or clean
    'start_idx'         : 1,                # first simulation replicate index
    #'end_idx'           : 1000,             # last simulation replicate index
    'end_idx'           : 50000,             # last simulation replicate index
    'sim_batch_size'    : 1000,
    #'sim_batch_size'    : 5000,
    #'sim_batch_size'    : 1000,
    ...
    'min_num_taxa'      : 4,               # min number of taxa for valid sim
    'max_num_taxa'      : 60000,              # max number of taxa for valid sim

    'rel_extant_age_tol': 1E-14,
    'tree_width'        : 32,              # tree width category used to train network
