...
args = {
    ...
    #-------------------------------#
    'sim_command'       : 'Rscript ../sim_tree.R 200 200', # exact command string, argument is output file prefix
    ...
    'char_format'       : 'csv',
    'min_num_taxa'       : 200,                   # Minimum number of taxa allowed when formatting
    'max_num_taxa'       : 200,                  # Maximum number of taxa allowed when formatting
    'shuffle_test'       : 'F', 
