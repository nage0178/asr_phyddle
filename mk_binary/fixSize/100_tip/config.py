...
args = {
    ...
    #-------------------------------#
    'sim_command'       : 'Rscript ../sim_varyTree.R 100', # exact command string, argument is output file prefix
    ...
    'char_format'       : 'csv',
    'min_num_taxa'       : 100,                  # Minimum number of taxa allowed when formatting
