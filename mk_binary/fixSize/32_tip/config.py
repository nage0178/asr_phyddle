...
args = {
    ...
    #-------------------------------#
    'sim_command'       : 'Rscript ../sim_varyTree.R 32', # exact command string, argument is output file prefix
    ...
    'char_format'       : 'csv',
    'min_num_taxa'       : 32,                  # Minimum number of taxa allowed when formatting
    'max_num_taxa'       : 32,                  # Maximum number of taxa allowed when formatting
